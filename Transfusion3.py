...
class Transfusion10(nn.Module):
    def __init__(self,
        ...
        super(Transfusion10,self).__init__()
    ...
    def forward(self,x):
        source = x
        x, intmd_x = self.encoder1(x)
        x = self.decoder(x)
        x1 = self.conv_module1(torch.cat((x,source),1))
        x2, intmd_x2 = self.encoder2(x1)
        x2 = self.decoder(x2)
        x2 = self.conv_module2(torch.cat((x2,x1,source),1))
        x3, intmd_x3 = self.encoder2(x2)
        x3 = self.decoder(x3)
        x3 = self.conv_module3(torch.cat((x3,x2,x1,source),1))
        x4, intmd_x4 = self.encoder2(x3)
        x4 = self.decoder(x4)
        x4 =self.conv_module4(torch.cat((x4,x3,x2,x1,source),1))
        return x1, x2, x3, x4


#纯transformer
class Transfusion11(nn.Module):
    def __init__(self,
                 img_dim=60,
                 patch_dim=3,
                 num_channels=2,
        ...
        super(Transfusion11,self).__init__()
...
class Transfusion12(nn.Module):
    def __init__(self,
        ...
        super(Transfusion12,self).__init__()
...
class Transfusion13(nn.Module):
    def __init__(self,
        ...
        super(Transfusion13,self).__init__()
        ...
        self.num_heads = num_heads
        self.patch_dim = patch_dim
        self.num_channels_0 = num_channels_0
        self.num_channels = num_channels
        self.num_channels_2 = num_channels_2
        self.num_channels_3 = num_channels_3
        self.dropout_rate = dropout_rate
        ...
        self.encoder0 = Transfusion_encode(self.img_dim, self.patch_dim, self.num_channels_0, self.embedding_dim,
                                           self.num_heads, self.num_layers, self.hidden_dim, self.dropout_rate,
                                           self.attn_dropout_rate, self.conv_patch_repersentation,
                                           self.positional_encoding_type)
    ...
    def forward(self,x):
        source = x
        x = self.backbone(x)
        x_Te1, intmd_x = self.encoder0(x)
        x_Td1 = self.decoder(x_Te1)
        x1 = self.conv_module1(torch.cat((x_Td1,source),1))
        x_Te2, intmd_x2 = self.encoder1(torch.cat((x1,x),1))
        x_Td2 = self.decoder(x_Te2)
        x2 = self.conv_module2(torch.cat((x_Td2,x1,source),1))
        x_Te3, intmd_x3 = self.encoder2(torch.cat((x2,x1,x),1))
        x_Td3 = self.decoder(x_Te3)
        x3 = self.conv_module3(torch.cat((x_Td3,x2,x1,source),1))
        x_Te4, intmd_x4 = self.encoder3(torch.cat((x3,x2,x1,x),1))
        x_Td4 = self.decoder(x_Te4)
        x4 =self.conv_module4(torch.cat((x_Td4,x3,x2,x1,source),1))
        return x1, x2, x3, x4
...
class Transfusion14(nn.Module):
    def __init__(self,
        ...
        super(Transfusion14,self).__init__()
    ...
    def forward(self,x):
        ...
        x1, intmd_x1 = self.encoder1(x)
        x1 = self.decoder(x1)
        x2,intmd_x2 = self.encoder2(torch.cat((x1,source),1))
        x2 = self.decoder(x2)
        x3, intmd_x3 = self.encoder3(torch.cat((x2,x1,source),1))
        x3 = self.decoder(x3)
        x4, intmd_x4 = self.encoder4(torch.cat((x3,x2,x1,source),1))
        x4 = self.decoder(x4)
...
class Transfusion16(nn.Module):
    def __init__(self,
        ...
        super(Transfusion16,self).__init__()
        ...
        self.conv_module1 = Transfusion_conv1()
        self.conv_module1_1 = Transfusion_conv1_1()
        self.conv_module2 = Transfusion_conv2()
        self.conv_module1_2 = Transfusion_conv1_2()
        self.conv_module3 = Transfusion_conv3()
        self.conv_module4 = Transfusion_conv4()
    ...
    def forward(self,x):
        ...
        x_Te1, intmd_x = self.encoder1(x)
        x_Td1 = self.decoder(x_Te1)
        x1 = self.conv_module1_1(x_Td1)
        x_Te2, intmd_x2 = self.encoder2(x1)
        x_Td2 = self.decoder(x_Te2)
        x2 = self.conv_module1_2(torch.cat((x_Td2,x1),1))
        x_Te3, intmd_x3 = self.encoder3(x2)
        x_Td3 = self.decoder(x_Te3)
        x3 = self.conv_module1(torch.cat((x_Td3,x2,x1),1))
        x_Te4, intmd_x4 = self.encoder4(x3)
        x_Td4 = self.decoder(x_Te4)
        x4 =self.conv_module4(torch.cat((x_Td4,x3,x2,x1,source),1))
        return x1, x2, x3, x4
...
class Transfusion17(nn.Module):
    def __init__(self,
        ...
        super(Transfusion17,self).__init__()
        ...
        self.conv_module1 = Transfusion_conv1_1()
        self.conv_module2 = Transfusion_conv2()
        self.conv_module3 = Transfusion_conv3()
        self.conv_module4 = Transfusion_conv4()
    ...
    def forward(self,x):
        ...
        x_Te1, intmd_x = self.encoder1(x)
        x_Td1 = self.decoder(x_Te1)
        x1 = self.conv_module1(x_Td1)
        #x_Te2, intmd_x2 = self.encoder2(x1)
        #x_Td2 = self.decoder(x_Te2)
        #x2 = self.conv_module2(x_Td2)
        #x_Te3, intmd_x3 = self.encoder3(x2)
        #x_Td3 = self.decoder(x_Te3)
        #x3 = self.conv_module3(x_Td3)
        #x_Te4, intmd_x4 = self.encoder4(x3)
        #x_Td4 = self.decoder(x_Te4)
        #x4 =self.conv_module4(x_Td4)
        return x1
...
class Transfusion18(nn.Module):
    def __init__(self,
        ...
        super(Transfusion18,self).__init__()
    ...
    def forward(self,x):
        ...
        x_Td1 = self.decoder(x_Te1)
        #x1 = self.conv_module1(torch.cat((x_Td1,source),1))
        x_Te2, intmd_x2 = self.encoder2(x_Td1)
        x_Td2 = self.decoder(x_Te2)
        #x2 = self.conv_module2(torch.cat((x_Td2,x1,source),1))
        x_Te3, intmd_x3 = self.encoder3(x_Td2)
        x_Td3 = self.decoder(x_Te3)
        #X3 = self.conv_module3(torch.cat((x_Td3,x2,x1,source),1))
        x_Te4, intmd_x4 = self.encoder4(x_Td3)
        x_Td4 = self.decoder(x_Te4)
        #x4 =self.conv_module4(torch.cat((x_Td4,x3,x2,x1,source),1))
        return x_Td1, x_Td2, x_Td3, x_Td4


#纯T有全连接
class Transfusion19(nn.Module):
    def __init__(self,
                 img_dim=60,
                 patch_dim=3,
                 num_channels=2,
        ...
        super(Transfusion19,self).__init__()
    ...
    def forward(self,x):
        ...
        x_Td1 = self.decoder(x_Te1)
        #x1 = self.conv_module1(torch.cat((x_Td1,source),1))
        x_Te2, intmd_x2 = self.encoder2(torch.cat((x_Td1,source),1))
        x_Td2 = self.decoder(x_Te2)
        #x2 = self.conv_module2(torch.cat((x_Td2,x1,source),1))
        x_Te3, intmd_x3 = self.encoder3(torch.cat((x_Td2,x_Td1,source),1))
        x_Td3 = self.decoder(x_Te3)
        #X3 = self.conv_module3(torch.cat((x_Td3,x2,x1,source),1))
        x_Te4, intmd_x4 = self.encoder4(torch.cat((x_Td3,x_Td2,x_Td1,source),1))
        x_Td4 = self.decoder(x_Te4)
        #x4 =self.conv_module4(torch.cat((x_Td4,x3,x2,x1,source),1))
        return x_Td1, x_Td2, x_Td3, x_Td4
...
class Transfusion20(nn.Module):
    def __init__(self,
        ...
        super(Transfusion20,self).__init__()
...
class Transfusion21(nn.Module):
    def __init__(self,
        ...
        super(Transfusion21,self).__init__()
...
class Transfusion22(nn.Module):
    def __init__(self,
        ...
        super(Transfusion22,self).__init__()
    ...
    def forward(self,x):
        ...
        x_Te2, intmd_x2 = self.encoder2(x1)
        x_Td2 = self.decoder(x_Te2)
        x2 = self.conv_module1_1(x_Td2)
        x_Te3, intmd_x3 = self.encoder3(x2)
        x_Td3 = self.decoder(x_Te3)
        x3 = self.conv_module1_1(x_Td3)
        x_Te4, intmd_x4 = self.encoder4(x3)
        x_Td4 = self.decoder(x_Te4)
        x4 =self.conv_module1_1(x_Td4)
        return x1, x2, x3, x4


#T有全连接C无全连接
class Transfusion23(nn.Module):
    def __init__(self,
                 img_dim=60,#60
                 patch_dim=3,#3
                 num_channels=2,
        ...
        super(Transfusion23,self).__init__()
...
class Transfusion24(nn.Module):
    def __init__(self,
        ...
        super(Transfusion24,self).__init__()
    ...
    def forward(self,x):
        ...
        #x_Te1, intmd_x = self.encoder1(x)
        #x_Td1 = self.decoder(x_Te1)
        x1 = self.conv_module1_2(source)
        #x_Te2, intmd_x2 = self.encoder2(torch.cat((x1,source,x_Td1),1))
        #x_Td2 = self.decoder(x_Te2)
        x2 = self.conv_module1_1(x1)
        #x_Te3, intmd_x3 = self.encoder3(torch.cat((x2,source,x_Td1,x_Td2),1))
        #x_Td3 = self.decoder(x_Te3)
        x3 = self.conv_module1_1(x2)
        #x_Te4, intmd_x4 = self.encoder4(torch.cat((x3,source,x_Td1,x_Td2,x_Td3),1))
        #x_Td4 = self.decoder(x_Te4)
        x4 =self.conv_module1_1(x3)
        return x1, x2, x3, x4